...
- (void)viewDidAppear:(BOOL)animated {
    ...
    if (![PFUser currentUser]) {
        ...
        WHLoginViewController *logInViewController = [[WHLoginViewController alloc] init];
...
- (void)downloadUserProfilePictures {
    ...
    NSURL *profilePictureURL = [NSURL URLWithString:[NSString stringWithFormat:@"https://graph.facebook.com/%@/picture?type=large", [[PFUser currentUser] objectForKey:kWearHacksUserFacebookIDKey]]];
...
- (void)connectionDidFinishLoading:(NSURLConnection *)connection {
    [WHUtility processFacebookProfilePictureData:_data];
}
